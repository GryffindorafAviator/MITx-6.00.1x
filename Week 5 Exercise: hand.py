...
class Hand(object):
    ...
    def update(self, word):
        ...
        # The following code can subtract the quantity of letters in hand even the return is false.
        
        # for letter in word:
        #     try:
        #         self.hand[letter] -= 1
        #         assert self.hand[letter] >= 0
        #
        #     except:
        #         return False
        #
...
#
# myHand = Hand(9)
# myHand.setDummyHand('muumgnafu')
# myHand.update('plum')
# print(myHand)

myHand = Hand(9)
myHand.setDummyHand('abrbyvgvu')
myHand.update('boar')
print(myHand)
